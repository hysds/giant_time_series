...
def main(input_json_file):
    ...
    id = "displacement-time-series-sbas_{}-{}".format(match.group(1), DATASET_VERSION)
    ...
    # create browse image
    call_noerr('gdal_translate HDF5:"LS-PARAMS.h5"://rawts browse.tif -of GTiff -outsize 50% 50% -b 2')
